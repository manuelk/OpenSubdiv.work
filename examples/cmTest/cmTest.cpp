...
Far::SubdivisionPlan::EndCapType g_endCap = Far::SubdivisionPlan::ENDCAP_BILINEAR_BASIS;
...
getAdaptiveColor(Far::SubdivisionPlan::Node node, int maxLevel) {
    ...
    if (desc.GetType()==Far::SubdivisionPlan::NODE_REGULAR) {
        ...
        Far::SubdivisionPlan::EndCapType endtype =
            node.GetSubdivisionPlan()->GetTopologyMap().GetEndCapType();
        switch (endtype) {
            case Far::SubdivisionPlan::ENDCAP_BILINEAR_BASIS : break;
            case Far::SubdivisionPlan::ENDCAP_BSPLINE_BASIS : break;
            case Far::SubdivisionPlan::ENDCAP_GREGORY_BASIS : patchType = 6; break;
            default:
                break;
        }
...
callbackEndCap(int endCap) {
    g_endCap = (Far::SubdivisionPlan::EndCapType)endCap;
    rebuildMeshes();
}
...
initHUD() {
    ...
    g_hud.AddPullDownButton(endcap_pulldown, "Bilinear",
        Far::SubdivisionPlan::ENDCAP_BILINEAR_BASIS, g_endCap == Far::SubdivisionPlan::ENDCAP_BILINEAR_BASIS);
    g_hud.AddPullDownButton(endcap_pulldown, "BSpline",
        Far::SubdivisionPlan::ENDCAP_BSPLINE_BASIS, g_endCap == Far::SubdivisionPlan::ENDCAP_BSPLINE_BASIS);
    g_hud.AddPullDownButton(endcap_pulldown, "GregoryBasis",
        Far::SubdivisionPlan::ENDCAP_GREGORY_BASIS, g_endCap == Far::SubdivisionPlan::ENDCAP_GREGORY_BASIS);
