...
public:
    ...
    // Constructor
    SubdivisionPlanBuilder(TopologyRefiner const & refiner, TopologyMap const & topomap);
    ...
    // has been called
    SubdivisionPlan * Create(Neighborhood const * neighborhood,
...
private:
    ...
    void setFaceTags(FaceTags & tags, int levelIndex, Index faceIndex) const;
...
private:
    ...
    LocalPointHelper * _stencilHelper;
...
private:    
    ...
    void gatherIrregularPatchPoints(int level, Index face, int offset, Index * supports) const;
