...
private:
    ...
    static inline unsigned int packBitfield(unsigned int value, int width, int offset) {
        return (unsigned int)((value & ((1<<width)-1)) << offset);
    }

    static inline unsigned int unpackBitfield(unsigned int value, int width, int offset) {
